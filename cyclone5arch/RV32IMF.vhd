...
-- i made a mistake when coding address calculation for rs1 and rs2, i flipped then,hence im just going to flip the data
	int_readE<=int_operand1D ;
	fp_readE<=fp_operand1D;
end if;
end process;
