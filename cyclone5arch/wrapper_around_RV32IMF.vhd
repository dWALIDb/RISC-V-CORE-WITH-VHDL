...
port(
	...
	GP_IN:in std_logic_vector(1 downto 0);
	serial_tx,tx_done,rx_done,pwm,GP_OUT,LED_BUILTIN_GPIO:out std_logic
);
...
signal 	gp_in_reg	:std_logic_vector(1 downto 0);
...
begin
if(rst='1')then gp_out_reg<='0';gp_in_reg<=(others=>'0');
elsif(clk'event and clk='1') then 
...
IN_DATA<= std_logic_vector(counter(31 downto 0))   when OUT_DATA(7 downto 0)=x"00" else 
			 ...
			 x"0000000"&"00"&gp_in_reg						when OUT_DATA(7 downto 0)=x"41"else 
