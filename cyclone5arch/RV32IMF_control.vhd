...
Wfp_wd<='0';Wfp_rd1<='0';Wfp_rd2<='0';Wwriteback_op<='0';Waddress_calculate<='0';cycle_count<=0;Wpc_enable<='0';Winterrupt_ack<='0';
	...
	--ALU considers least 5-bits of sign extended value
		...
		--LOAD INTEGER REGISTER:ALU output has the address offset 								 NOTE:no need to check func3 like this if(func3="010") because i made a memory that uses func3 for load and store ops
		when"0000011"=> Wram_rd<='1';Wint_wd<='1';Wint_rd1<='1';Wint_srcB<="10";Wwriteback_op<='1';
		--STORE INTEGER REGISTER:address is calculated then multiplexed with alu output   NOTE:  no need to check func3 like this if(func3="010") because i made a memory that uses func3 for load and store ops
		when"0100011"=> Wram_wd<='1';Wint_rd1<='1';Wint_rd2<='1';Wram_src<="100";Waddress_calculate<='1';
