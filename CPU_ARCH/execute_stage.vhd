...
J_format<=upper_immediate_value(19)&upper_immediate_value(7 downto 0)&upper_immediate_value(8)&upper_immediate_value(18 downto 9);

--J_format<=upper_immediate_value(19)&upper_immediate_value(9 downto 0)&upper_immediate_value(10)&upper_immediate_value(18 downto 11);
...
--here jal uses current PC and not PC+4 hence we need to adjust for it here because offset calculation takes place with PC+4 just to make 1 adder for selected offset
--with PC+4 to get the address :) of next instruction took me 2 hours to debug cuz i wasn't understanding jal as i should :)  				 
--I LITERALLY LOST 2 DAYS JUST DEBUGGING THIS AAAAAAAAAAAAA
